...
use language::{
    ...
    CharClassifier, CharKind, CodeLabel, CursorShape, DiagnosticEntry, DiffOptions, IndentKind,
...
use ui::{
    ContextMenu, Disclosure, IconButton, IconButtonShape, IconName, IconSize, Tooltip, h_flex,
    prelude::*,
};
...
impl Editor {
    ...
    pub fn toggle_code_actions(
        ...
        cx.spawn_in(window, async move |editor, cx| {
            let (resolved_tasks, _) = runnable_task.await?;
