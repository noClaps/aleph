...
use extension::{
    CodeLabel, Command, Completion, ContextServerConfiguration, DownloadFileCapability,
    ExtensionCapability, ExtensionHostProxy, KeyValueStoreDelegate, NpmInstallPackageCapability,
